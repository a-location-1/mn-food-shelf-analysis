"""
Code generated by Claude Sonnet 4.6 on 30 Apr 2026.
...
Output:
    food_shelves_scrapedgeocoded_2026.pkl
"""
...
OUTPUT_PKL = "data/food_shelves_scrapedgeocoded_2026.pkl"
...
def parse_locations(locations: list) -> list[dict]:
    ...
    for loc in locations:
        ...
        lines = [
            t.strip()
            for t in content_soup.get_text("\n").splitlines()
...
def main():
    ...
    if not null_rows.empty:
        ...
        print(
            null_rows[["name", "address", "lat", "lng", "county"]].to_string(
                index=False
            )
        )
